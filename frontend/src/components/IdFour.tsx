...
import img1 from "../images/tablefan1a.webp";
import img2 from "../images/tablefan2.webp";
import img3 from "../images/tablefan3b.avif";
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-12 px-10 w-full pt-200 max-w-screen-xl pt-12">
          <div className="col-span-8">
            ...
            <div className="text-5xl font-extrabold">Table fan</div>
            <div>Rs: 1200</div>
            <div className="text-slate-500 pt-2">posted on 5th April 2024</div>
            <div className="pt-4">
              3 year old, Crompton table fan, Colour has gotten dull, else functions normal, can reduce price.This table fan is designed to provide efficient cooling with its compact and portable structure. It features a powerful motor with a power consumption of 50 watts, delivering strong airflow to keep your space comfortably cool. The fan offers adjustable speed settings, typically three levels, allowing you to customize the airflow according to your preference. It is equipped with a 90-degree oscillation function, ensuring even distribution of air throughout the room.
            </div>
