...
import img1 from "../images/shaon1.webp";
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-12 px-10 w-full pt-200 max-w-screen-xl pt-12">
          <div className="col-span-8">
            ...
            <div className="text-5xl font-extrabold">CPI</div>
            <div>Rs: 25</div>
            <div className="text-slate-500 pt-2">posted on 7th May 2024</div>
            <div className="pt-4">
             You really came here to buy CPI, damn bro, go and study
            </div>
            <div className="grid grid-cols-2 md:grid-cols-2 gap-2 py-4">
            <img className="w-70 h-70" src={img1} alt="image description" />
            </div>
          </div>
          ...
          <div className="col-span-4">
            <div className="text-slate-600 text-lg">Click below to view profile:</div>
                ...
                <Link to={"/prof6"} className="flex items-center p-4">
                  <div className="pr-4 flex flex-col justify-center">
                    <Avatar size={"big"} name="Shadndeep Shondal" />
                  </div>
                  <div>
                    <div className="text-xl font-bold">Shaondeep Shondal</div>
                    <div className="pt-2 text-slate-500">
                      Choose me for a lifetime of premium value
                    </div>
                  </div>
                </Link>
              </div>
