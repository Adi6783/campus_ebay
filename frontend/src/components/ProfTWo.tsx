...
export function Prof2(){
    ...
    >
      ...
      <div className="mt-20 text-center border-b pb-12">
        <h1 className="text-4xl font-medium text-gray-700">Akshat Sharma, <span className="font-light text-gray-500">27</span></h1>
      ...
      <div className="mt-12 flex flex-col justify-center">
        <p className="text-gray-600 text-center font-light lg:px-16">Leader</p>
        <button
