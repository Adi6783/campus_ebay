...
export function Prof3(){
    ...
    >
      ...
      <div className="mt-20 text-center border-b pb-12">
        <h1 className="text-4xl font-medium text-gray-700">Harshit Jaiswal, <span className="font-light text-gray-500">27</span></h1>
        <p className="font-light text-gray-600 mt-3">Hall 12, IIT-K</p>
    
        <p className="mt-8 text-gray-500"></p>
        <p className="mt-2 text-gray-500">Chemical Engg, IITK</p>
      </div>
    
      <div className="mt-12 flex flex-col justify-center">
        <p className="text-gray-600 text-center font-light lg:px-16">Sasta samaan do bhai </p>
        <button
